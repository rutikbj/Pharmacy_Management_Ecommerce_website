...
<body>
<center><a href="admin-index.jsp" class="btn btn-warning">Home</a></center>
...
<tr>
	<td><b>Status:</b></td>
	<td><%=rs1.getInt(9)==0?"Pending":"Dispatched"%> <a href="dispatch.jsp?oid=<%=rs1.getString(1)%>" class="btn btn-danger">Dispatch</a></td>
</tr>	
</table>
<table class="table table-bordered">
<tr class="danger">
